...
public class LookForTankFSMBehaviour extends FSMBehaviour {
	...
	this.registerTransition("RECEIVE-TANK-BROADCAST", "RECEIVE-ASSIST-REQUEST", FSMCodes.Events.FAILURE.ordinal());
	this.registerTransition("RECEIVE-ASSIST-REQUEST", "ASSIST", FSMCodes.Events.SUCESS.ordinal());
	this.registerTransition("RECEIVE-ASSIST-REQUEST", "GO-TO", FSMCodes.Events.FAILURE.ordinal());
	this.registerTransition("ASSIST", "START-LOOK-FOR-TANK", FSMCodes.Events.SUCESS.ordinal());
